...
export async function loadProgram(gl:WebGL2RenderingContext, vsSource:string, fsSource:string, attributeNames:string[], uniformNames:string[]) {
...
async function loadShader(gl:WebGL2RenderingContext, type:number, url:string) {
